...
what gets sent to VaakMirror's routes too. This works because, post-merge,
both sides now literally share the same core.config.Settings — no separate
secret_key/algorithm to keep in sync anymore.
