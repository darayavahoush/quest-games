...
from vaakmirror.models import AssignmentStatus, ExerciseAssignment, ExerciseTemplate
from vaakmirror.schemas import AssignmentStatusUpdate, ExerciseAssignmentOut, ExerciseTemplateOut

router = APIRouter(tags=["vaakmirror-exercises"])
